...
class TestCourierCreate:
    ...
    @allure.description("Тест, который падает, по созданию рандомного курьера, где я перепробывал рандомные данные при которых мне отвечает система - такой курьер уже есть")
